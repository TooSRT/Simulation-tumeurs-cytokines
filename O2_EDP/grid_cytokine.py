...
class cytokine_Grid :
    ...
    This class represents a grid for cytokine concentration simulation.
    ...
    def print(self, c, X, Y, Nx, t):
        ...
        plt.title("Cytokine concentration at t = " + str(t) + "h")
        plt.xlabel('1' + self.unit)
        plt.ylabel('1' + self.unit)
        plt.colorbar(surf, shrink=0.5, aspect=10)
        plt.savefig('./plot/cytokine_pictures/cytokine_concentration at t =' + str(t) + 'h.png')
        plt.clf()