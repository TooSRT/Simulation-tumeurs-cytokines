...
class Tcells_mvt:
    ...
    """
    def __init__(self, Nx, pos0, w0, w_max, delta_x, delta_t, D_tcells):
        """
    ...
    def psi(self,w):
        ...
        Args:
            w_i (float): Densité totale de cellules à la position i.
        Returns:
            float: Valeur de la fonction psi.
        """
        w_max=self.w_max
    ...
    def movement(self):
        ...
        movement_vector = np.zeros(len(self.pos),dtype=int) #initialize our movement vector 
        prob_moove = np.zeros((l,3)) #initialize our probability vector 
